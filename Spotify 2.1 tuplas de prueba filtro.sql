...
-- Barton (Necesitaba probar el filtro)
describe playlist;
select * from playlist;
insert into playlist (nombrePlaylist, descripcionPlaylist, codigoUsuario, cantidadCanciones, codigoCancion)
	values ('Prueba1','desp1',1,50,1),
		('Prueba1','desp1',1,50,2),
        ('Prueba2','desp1',2,50,3),
        ('Prueba2','desp1',2,50,4),
        ('Prueba1','desp1',1,50,1);
        
describe historialbusqueda;
insert into historialbusqueda (fechaHB, horaHB, palabraBuscada, codigoUsuario)
	values (now(),now(),'potasio',1),
    (now(),now(),'pepe',1),
    (now(),now(),'sech',2),
    (now(),now(),'tilin',1);
    ...
    describe historialreproduccion;
    
    insert into historialreproduccion(fechaHR, horaHR, Origen, codigoUsuario)
		values	(now(),now(),'de donde viene 1', 1),
        (now(),now(),'de donde viene 2', 1),
        (now(),now(),'de donde viene 3', 1),
        (now(),now(),'de donde viene 4', 1),
        (now(),now(),'de donde viene 515', 2);
        select * from historialreproduccion;
        
        
        describe favoritos;
        
        insert into favoritos (cantidadCanciones, duraciónTotal, cantidadArtistas, codigoUsuario, codigoCancion)
			values (12,'pepepepepe',13,1,1),
            (11,'asfsaf',13,1,1),
            (12,'fas',13,2,1),
            (22,'us1',13,1,1),
            (44,'asd',13,2,1),
