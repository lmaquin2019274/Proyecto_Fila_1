...
insert into Artista (nombreArtista,fechaNacimiento,paisNacimiento)
value ('The Weeknd','1990-02-16','Canada');
insert into Artista (nombreArtista,fechaNacimiento,paisNacimiento)
...
insert into Album (nombreAlbum, generoComun, fechaLanzamiento,codigoArtista) 
values('Dawn FM','Hip Hop','2022-01-07',6);
insert into Album (nombreAlbum, generoComun, fechaLanzamiento,codigoArtista) 
values('Starboy','Hip Hop','2016-11-25',6);
insert into Album (nombreAlbum, generoComun, fechaLanzamiento,codigoArtista) 
values('AstroWorld','Trap','2018-08-03',7);
insert into Album (nombreAlbum, generoComun, fechaLanzamiento,codigoArtista) 
values('Utopia','Trap','2023-07-28',7);
insert into Album (nombreAlbum, generoComun, fechaLanzamiento,codigoArtista) 
