<%-- 
    ...
    Created on : 29/08/2023, 10:32:17 AM
    Author     : informatica
--%>
...
<html>
    ...
    <body>
        <div class="container">
            <h1>Edita tu playlist: <%= ((Playlist) request.getAttribute("play")).getNombrePlaylist() %></h1>
            ...
            <form class="form" action="Controlador" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtNombrePlaylist" value="<%= ((Playlist) request.getAttribute("play")).getNombrePlaylist() %>">
                </div>
                <input type="hidden" class="form-control" name="txtIdPlaylist" value="<%= ((Playlist) request.getAttribute("play")).getCodigoPlaylist() %>">
                <div class="form-group">
                    <label class="form-label">Descripción</label>
                    <input type="text" class="form-control" name="txtDescripcionPlaylist" value="<%= ((Playlist) request.getAttribute("play")).getDescripcionPlaylist()%>">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" name="accion" value="ActualizarPlaylist">Actualizar</button>
