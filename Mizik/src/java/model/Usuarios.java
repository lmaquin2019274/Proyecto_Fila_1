...
public class Usuarios {
    ...
    public static String getCorreoA() {
        return correoA;
    }

    public static void setCorreoA(String correoA) {
        Usuarios.correoA = correoA;
    }
