...
public class Controlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("principal")) {
            ...
            List<HistorialReproduccion> historialReproduccion = hrDAO.listarHistorialReproduccion(codigoUsuario);
            ...
            int codigoUsuario = (int) request.getSession().getAttribute("codigoUsuario");
            List<HistorialBusqueda> historialBusqueda = hbDAO.listarHistorialBusqueda(codigoUsuario);
