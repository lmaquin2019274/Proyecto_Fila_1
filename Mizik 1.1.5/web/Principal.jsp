    ...
    <body id="body">
        ...
        <main>
            <div id="inicio">
                ...
                <div class="image_biblioteca">
                    <div class="content_biblioteca">
                        <a href="Controlador?accion=album">
                            <i class="fa-solid fa-record-vinyl" style="color: #2b6895;"></i>
                        </a>
                    </div>
                    <a class="link" href="Controlador?accion=album">Los mejores álbumes</a>
                </div>
            </div>
            ...
            <div id="buscar" style="display: none;">
                <h1>Buscar</h1>
                <br>
                <p>*inserte barra de búsqueda*</p>
                <br>
                <div class="image_biblioteca">
                    <div class="content_biblioteca">
                        <a href="Controlador?accion=canciones">
                            <i class="fa-solid fa-headphones-simple" style="color: #9a560;"></i>
                        </a>
                    </div>
                ...
                <div class="image_biblioteca">
                    <div class="content_biblioteca">
                        <a href="Controlador?accion=genero">
                            <i class="fa-solid fa-compact-disc" style="color: #a60053;"></i>
                        </a>
                    </div>
            ...
            <div id="opciones" style="display: none;">
                ...
                <a href="Controlador?accion=config">Sobre nosotros</a><br>
            </div>
        </main>
